...
![The NixOS test driver framework](./assets/nixos-integration-test-driver-kit.jpg){ align=right width="300" }
...
-   **Mastering NixOS Integration Tests Part 2**
    ...
    ![The NixOS test driver framework](./assets/nixos-integration-test-driver-kit.jpg){ align=left width=200 }
